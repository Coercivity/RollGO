...
public class LobbyDbContext(DbContextOptions<LobbyDbContext> options) : DbContext(options)
{
    ...
    public DbSet<MeetingEntertainmentEntityLink> MeetingEntertainmentEntityLink { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new MeetingEntertainmentEntityLinkMapping());
