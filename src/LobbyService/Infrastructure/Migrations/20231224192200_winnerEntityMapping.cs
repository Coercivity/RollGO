    ...
    public partial class winnerEntityMapping : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        RatingKinopoisk = table.Column<double>(
                            type: "double precision",
                            nullable: false
                        ),
                        RatingImdb = table.Column<double>(
                            type: "double precision",
                            nullable: false
                        ),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("472d95cc-381a-4d2f-b5eb-3fb282b10920"),
                        new Guid("d754bb36-659d-4734-81f5-76ab8fe6b69b"),
                        new DateTime(2023, 12, 24, 19, 22, 0, 128, DateTimeKind.Utc).AddTicks(9816),
                        "spark"
                    },
                    {
                        new Guid("b70bd0bc-7309-46c1-a62f-816f668aad5e"),
                        new Guid("3b05d3a6-7445-4f85-a07f-c45a70177647"),
                        new DateTime(2023, 12, 24, 19, 22, 0, 128, DateTimeKind.Utc).AddTicks(9785),
                        "yo_mama"
                    },
                    {
                        new Guid("e06acd16-ab24-44f7-baa3-1b5d07d73b0c"),
                        new Guid("fa4812f1-20e6-4795-be8b-8fe5de551265"),
                        new DateTime(2023, 12, 24, 19, 22, 0, 128, DateTimeKind.Utc).AddTicks(9812),
                        "impostor"
                    }
                }
            );
        ...
        {
            migrationBuilder.DropTable(name: "LobbyUser");

            migrationBuilder.DropTable(name: "Meeting");

            migrationBuilder.DropTable(name: "UserWeight");

            migrationBuilder.DropTable(name: "EntertainmentEntity");

            migrationBuilder.DropTable(name: "Lobby");
        }
    }
}
